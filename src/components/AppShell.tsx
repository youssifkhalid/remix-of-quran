      ...
      <div className="relative min-h-dvh bg-background text-foreground">
        ...
        <div className="lg:flex lg:min-h-dvh">
          ...
          <aside className="fixed-chrome hidden lg:flex lg:flex-col lg:w-[248px] xl:w-[272px] shrink-0
            sticky top-0 h-dvh border-l border-border overflow-y-auto scroll-area
            bg-surface z-40">

            {/* Logo */}
            <Link to="/" className="flex items-center gap-3 px-5 pt-6 pb-5">
              <div className="relative">
                <SakinahLogo size={44} className="text-foreground" />
            ...
            {!isAiChat && (
              <div className="mobile-shell-bar fixed-chrome lg:hidden">
                <Link to="/" className="flex min-w-0 items-center gap-2 text-right">
                  <SakinahLogo size={38} className="shrink-0 text-foreground" />
        ...
        {menuOpen && (
          <div className="fixed-chrome lg:hidden fixed inset-0 z-[70] bg-background">
